...
- `TOOLBOX.bat`: single toolbox entry point (Windows).
- `_tools/ps/*`: PowerShell 5.1 toolbox scripts (backup/git/smoke/dev).
...
Use `TOOLBOX.bat` for backup/restore and git toolbox operations.
